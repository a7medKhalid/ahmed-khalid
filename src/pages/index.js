...
const IndexPage = () => {
  ...
  return (
    <div className="bg-slate-950  w-full min-h-screen">
        ...
        <div class="bg-slate-950 md:fixed md:top-0 md:left-0 w-full text-white p-8 ">
        ...
        <div className={`bg-slate-900 flex md:flex-col px-4 md:px-0  fixed md:top-1/2 md:transform md:-translate-y-1/2  translate-x-1/2 md:translate-x-1 right-1/2 md:right-0 bottom-0  rounded-t-2xl md:rounded-r md:rounded-l-2xl  text-white`}>
            ...
            <div className="relative flex flex-col items-center p-2 md:p-4">
                ...
                <p className="text-xs mt-1 md:text-sm"> مشاريع</p>
            </div>
            ...
            <div className="relative flex flex-col items-center p-2 md:p-4">
                ...
                <p className="text-xs mt-1 md:text-sm"> خدماتنا</p>
            </div>
