...
const IndexPage = () => {
  ...
  return (
    <div className="w-full min-h-screen" style={{backgroundColor:"#1a202c"}}>
        ...
        <div className=" md:fixed md:top-0 md:left-0 w-full text-white p-8 md:p-0 " style={{backgroundColor:"#1a202c"}}>
           <div className="flex items-center justify-center flex-col md:flex-row-reverse">
                <div>
                    <img className="md:ml-4 mt-4 md:h-14 md:w-14 h-36 w-36 rounded-full ring-2 ring-white" src={Avatar} alt=""/>
                </div>
                <div className="mt-8 md:mr-8">
                    <div className="p-4">
                        <h1 className="text-4xl md:text-xl font-bold">أحمد خالد</h1>
                        <p className="text-xs text-gray-400 "> مهندس برمجيات عملت مع العديد من الجهات والأفراد <br/> على تطوير مشاريعهم التقنية</p>
                    </div>
        ...
        <div className={`bg-slate-900 flex md:flex-col px-4 md:px-0  fixed translate-x-1/2 md:translate-x-1 right-1/2 md:right-0 bottom-0 md:bottom-1/2 md:translate-y-1/2 rounded-2xl md:rounded-r md:rounded-l-2xl mb-8 md:mb-0 text-white`}>
            ...
            <div className="relative flex flex-col items-center p-2 md:p-2">
                ...
                <Articles className="inline-block w-8 h-8 md:w-8 md:h-8 mr-1 md:mr-2 hover:animate-bounce" onClick={() => setSelectedComponent('articles')}/>
            ...
            <div className="relative flex flex-col items-center p-2 md:p-2">
                ...
                <Projects className="inline-block w-8 h-8 md:w-8 md:h-8 mr-1 md:mr-2 hover:animate-bounce " onClick={() => setSelectedComponent('projects')}/>
            ...
            <div className="relative flex flex-col items-center p-2 md:p-2">
                ...
                <Services className="inline-block w-8 h-8 md:w-8 md:h-8 mr-1 md:mr-2 hover:animate-bounce" onClick={() => setSelectedComponent('services')}/>
                <p className="text-xs mt-1 md:text-sm"> الرئيسة</p>
            </div>
        ...
        <div className="content-area md:mt-14 ">
