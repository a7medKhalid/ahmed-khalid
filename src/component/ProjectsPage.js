    ...
    render() {
        return (
            <div className="projects-container flex flex-col items-center text-white p-4">
                ...
                <article key={index} className="md:w-3/5 flex flex-col shadow my-4">
                    
                    <img className="rounded-t " src={project.image} alt={project.title} />
    
                     <div className="bg-gray-800 flex flex-col justify-start p-6">
                         <a href="#" className="text-3xl font-bold hover:text-gray-700 text-white pb-4">{project.title}</a>
                         
                         <a href="#" className="pb-6 text-white">{project.desc}</a>
